...
div[data-testid="stButton"] > button {
    background:#7c6af5; color:#fff; border:none; border-radius:9px;
    font-size:0.88rem; font-weight:500; padding:9px 20px;
    width:100%; transition:background 0.2s;
}
div[data-testid="stButton"] > button:hover  { background:#6a58e0; color:#fff; border:none; }
div[data-testid="stButton"] > button:disabled { background:#2a2a3a; color:#5a5a7a; }
